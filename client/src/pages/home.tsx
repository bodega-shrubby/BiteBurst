    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-8 py-16 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Character Scene - Exact recreation from complete design */}
          <div className="relative mb-16 h-80">
            ...
            <div className="absolute top-8 left-20">
              <div className="relative">
                ...
                <div className="absolute -top-1 -left-1 star-sparkle text-yellow-300 text-lg">✦</div>
                <div className="absolute top-2 left-2 star-sparkle text-yellow-500 text-sm">✦</div>
              </div>
            </div>
            
            {/* Top center large star */}
            <div className="absolute top-4 left-1/2 transform -translate-x-1/2">
              <div className="star-sparkle text-yellow-400 text-4xl">✦</div>
            </div>
            
            {/* XP text with decorative stars */}
            <div className="absolute top-12 right-24">
              <div className="flex items-center space-x-2">
                <span className="text-yellow-500 font-bold text-3xl">XP</span>
            ...
            {/* Main character lineup */}
            <div className="absolute bottom-0 left-0 right-0 flex justify-center items-end space-x-8">
              
              {/* 1. Orange slice mascot (waving, left) */}
              <div className="relative">
                <img 
                  src={mascotImage} 
                  alt="BiteBurst Mascot" 
              ...
              {/* 2. Girl in yellow hoodie (lunging/action pose) */}
              <div className="relative">
                <img 
              ...
              {/* 3. Green apple (floating, center-left) */}
              <div className="relative">
                <div className="w-12 h-12 bg-green-500 rounded-full relative shadow-lg animate-float-delayed">
                  ...
                  {/* Apple leaf */}
                  <div className="absolute -top-0.5 left-1/2 transform -translate-x-1/2 translate-x-1 w-2 h-1 bg-green-600 rounded-full transform rotate-45"></div>
                  {/* Apple highlight */}
                  <div className="absolute top-2 left-2 w-4 h-4 bg-green-300 rounded-full opacity-70"></div>
                </div>
              </div>
              ...
              {/* 5. Red apple (floating, center-right) */}
              <div className="relative">
                <div className="w-10 h-10 bg-red-500 rounded-full relative shadow-lg animate-float">
                  {/* Apple stem */}
                  <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-1 h-1.5 bg-green-700 rounded-full"></div>
                  {/* Apple leaf */}
                  <div className="absolute -top-0.5 left-1/2 transform -translate-x-1/2 translate-x-0.5 w-1.5 h-0.5 bg-green-600 rounded-full transform rotate-45"></div>
                  {/* Apple highlight */}
                  <div className="absolute top-1.5 left-1.5 w-3 h-3 bg-red-300 rounded-full opacity-70"></div>
                </div>
              </div>

              {/* 6. Girl with dark hair eating yellow fruit (standing, far right) */}
              <div className="relative">
                <div className="w-16 h-24 relative">
                  ...
                  <div className="w-12 h-12 bg-yellow-100 rounded-full relative">
                    ...
                    <div className="absolute top-1 -left-1 w-3 h-12 bg-gray-900 rounded-full"></div>
                    <div className="absolute top-1 -right-1 w-3 h-12 bg-gray-900 rounded-full"></div>
                  ...
                  {/* Coral/pink top */}
                  <div className="absolute top-9 left-1 w-10 h-7 bg-red-400 rounded-lg"></div>
                  
                  {/* Arms */}
                  <div className="absolute top-10 -left-1 w-3 h-6 bg-yellow-100 rounded-full"></div>
                  <div className="absolute top-10 right-1 w-3 h-6 bg-yellow-100 rounded-full"></div>
                  
                  {/* Yellow fruit being eaten */}
                  <div className="absolute top-8 right-2 w-2 h-3 bg-yellow-400 rounded-full"></div>
                  
                  {/* Blue jeans/pants */}
                  <div className="absolute top-15 left-2 w-3 h-12 bg-blue-600 rounded-full"></div>
                  <div className="absolute top-15 right-2 w-3 h-12 bg-blue-600 rounded-full"></div>
