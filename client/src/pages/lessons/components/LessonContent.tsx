    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-orange-50 via-yellow-50 to-white">
      ...
      <main className="flex-1 overflow-y-auto pb-24">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row min-h-full">
          ...
          {/* Left Side - Mascot */}
          <div className="w-full md:w-2/5 lg:w-1/3 p-4 md:p-6 lg:p-8 flex flex-col items-center md:justify-start md:pt-12 justify-center bg-gradient-to-br from-orange-50 to-yellow-50 md:border-r-2 md:border-orange-100">
            {/* Mascot Avatar */}
